...
const repeatMyParam = () => {
    ...
    axios.get(`http://localhost:3000/repeat/'Chocolate'`)
    .then(res => {
...
/*
    ...
    The console logged that it had an empty query

    2: Send more than 1 query on the URL -- what happened? 
     
    You can send more than one query when they are seperated by commas
